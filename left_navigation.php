...
<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="dashboard.php" aria-expanded="false"><i
                        class="icon icon-single-04"></i><span class="nav-text">Dashboard</span></a>
            </li>
            <li class="nav-label">Apps</li>
            <li><a class="has-arrow" href="scripts_detail.php" aria-expanded="false"><i
                        class="icon icon-app-store"></i><span class="nav-text">Scripts</span></a>

            </li>
            <li><a class="has-arrow" href="users.php" aria-expanded="false"><i
