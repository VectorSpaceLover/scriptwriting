          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-title">
                <h4 class="pt-3 ml-3">Edit User</h4>

              </div>
              <div class="card-body">


                <form class="form-horizontal"  method='post' id='update_user_form'>
                  <input type='hidden' id='userid' name='userid' value=''>
                  <input type='hidden' id='function' name='function' value='updateuser'>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-primary" id="update_user"><i class='fa fa-save'></i> Save</button>
  ...
  ***********************************-->
  ...
  $(document).ready(function() {
    ...
    $.ajax({
      ...
      data:{'function':'edituserdata','userid':localStorage.setuserid},
      success:function(data)
      {
        ...
        $('input[name=usertype][value='+obj.type+']').prop('checked', 'checked');
      }
